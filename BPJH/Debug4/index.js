...
const handlers = {
    'LaunchRequest': function () {
      var speechOutput = "Welcome to the Calculator! I can compute any simple math function you want.";
      this.response.speak(speechOutput).listen("What would you like to do?");
      this.emit(':responseReady');
    },
    'AddIntent': function () {
        var num = this.event.request.slots.firstNum.value; 
        var sum = firstNum + secondNum; 
        var speechOutput = firstNum + "plus" + secondNum " is equal to " + sum; 
