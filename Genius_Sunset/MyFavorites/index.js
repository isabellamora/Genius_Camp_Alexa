...
const handlers = {
    'LaunchRequest': function () {
      var speechOutput = "Hello what is your name?";
    ...
    'nameIntent': function () {
        ...
        var speechOutput = "Hi " + name + ". What is your favorite cheese?";
    ...
    'myFavoriteCheeseIntent': function () {
        var cheese = this.event.request.intent.slots.myCheese.value;
        var speechOutput = "Eww I dont like " + cheese;
        var speechReprompt = "Let me say this again, this is my very first intent";
        this.response.speak(speechOutput).listen(speechReprompt);
        this.emit(':responseReady');
    },
