...
const handlers = {
    ...
    'NameIntent': function () {
        // var speechOutput = "your name is hector";
        // var speechReprompt = "hello hector, what do you like to eat?";
    ...
    'FoodIntent': function () {
        ...
        var speechOutput = "Wow you like " + food + " too? I really like " + food;
        var speechReprompt = "Wow you like " + food + " too? I really like " + food;
        this.response.speak(speechOutput).listen(speechReprompt);
        this.emit(':responseReady');
    },
