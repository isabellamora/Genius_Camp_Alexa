...
const handlers = {
    ...
    'PickIntent': function () {
        var studentList = ["Johnny Appleseed", "Hector Medina", "Celine Tran", "Mitchell Wang", "Caroline Zhu"];
        
        var random = Math.floor(Math.random()*studentList.length);
        
        var speechOutput = "I choose " + studentList[random]; 
        
        var speechReprompt = "Did you want another student?";
